...
const BidvBankTable = (props) => {
  ...
  const fetchAccountInfos = async () => {
    const accountDatas = await axios.get(`${env.API_URL}/bankInfo/bidv`);
            ...
            {rows
              ...
              .map((item, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell align="center">{item.money}</TableCell>
